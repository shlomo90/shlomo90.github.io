...
* (formal) to show something ; to carry something so that it can be seen
  * *Go bears a surface similarity to C and, like C,*


### beget /bɪˈɡet/ verb [beget begat begotten]

* (old use, for example in the Bible)
  **beget somebody** to become the father of a child
  * *Isaac begat jacob.*
...
### offspring /ˈɔːfsprɪŋ/ noun

* a child of a particular person or couple
  * *the problems parents have with their teenage offspring*


### accomodate /əˈkɑːmədeɪt/ verb

* to provide enough space for somebody/something
  * *The garage can accommodate three cars.*
* **accomodate something** to consider something such as somebody's opinion or
  a fact and be influenced by it when you are deciding what to do or explaining
  something
  * *Our proposal tries to accommodate the special needs of minority groups
* to help somebody by doing what they want
  * *I have accommodated the press a great deal, giving numerious interviews.*
  * *I'm sure the bank will be able to accommodate you.*


### triplet /ˈtrɪplət/ noun

* one of three children born at the same time to the same mother
* (music) a group of three equal notes to be played or sung in the time usually taken
  to play or sing two of the same kind
